...
public enum TheFoods{
    ...
    FISH_N_CHIPS("FishNChips", 14, 0.65F, false, 40, EnumRarity.COMMON),
    ...
    CHOCOLATE_CAKE("ChocolateCake", 16, 0.8F, false, 45, EnumRarity.COMMON),
    CHOCOLATE("Chocolate", 3, 0.3F, false, 15, EnumRarity.COMMON),
    TOAST("Toast", 3, 0.08F, false, 25, EnumRarity.COMMON),
    SUBMARINE_SANDWICH("SubmarineSandwich", 9, 0.4F, false, 40, EnumRarity.COMMON),
    BIG_COOKIE("BigCookie", 4, 0.25F, false, 20, EnumRarity.COMMON),
    HAMBURGER("Hamburger", 13, 0.65F, false, 40, EnumRarity.COMMON),
    PIZZA("Pizza", 16, 0.8F, false, 45, EnumRarity.COMMON),
    BAGUETTE("Baguette", 6, 0.5F, false, 25, EnumRarity.COMMON),
    RICE("Rice", 2, 0.05F, false, 10, EnumRarity.COMMON),
    RICE_BREAD("RiceBread", 6, 0.5F, false, 25, EnumRarity.COMMON),
    DOUGHNUT("Doughnut", 2, 0.1F, false, 10, EnumRarity.COMMON),
    CHOCOLATE_TOAST("ChocolateToast", 5, 0.2F, false, 40, EnumRarity.COMMON),
